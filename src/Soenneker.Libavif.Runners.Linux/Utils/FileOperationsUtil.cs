...
using Soenneker.Libavif.Runners.Linux.Utils.Abstract;
using Soenneker.Utils.Directory.Abstract;
using Soenneker.Utils.File.Download.Abstract;

namespace Soenneker.Libavif.Runners.Linux.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    private const string AssetName = "linux-artifacts.zip";
    private static readonly string[] _requiredFiles = ["avifenc", "avifdec", "avifgainmaputil"];
    ...
    public async ValueTask<string> Process(CancellationToken cancellationToken = default)
    {
        ...
        _logger.LogInformation("Prepared Linux x64 libavif runtime at {StageDirectory}", stageDirectory);
