...
namespace Soenneker.Libavif.Runners.Linux;
    ...
    public Task StartAsync(CancellationToken cancellationToken = default)
    {
        _appLifetime.ApplicationStarted.Register(() => Task.Run(async () =>
        {
            try
            {
                ...
                await _runnersManager.PushIfChangesNeededForDirectory(Path.Combine(Constants.RuntimeIdentifier, "libavif"), stageDirectory,
